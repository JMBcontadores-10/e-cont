...
class vinculacionAutomaticaTraslados extends Controller
{
    ...
    public function vincular(){
          ...
          ////////DESVICULAR TODOS LOS TRASLADOS/////
...
#========================================================================================#
                  /* OBTENCION DE TRASLADOS PARA VINCULAR */

     /// se obtienen todos los metadatos que no tengan vinculo y que sean TRASLADOS
            $metadataTraslado =MetadataR::whereNull('cheques_id')->where('efecto','Traslado')->where('estado','Vigente')->get();
...
#=========================================================================================#
    /* VINCULACION DE LOS TRASLADOS A SU CORRESPONDIENTE PPD (Ya vinculado a un cheque)   */
           $color="white";
  ...
  ////////////////[VERSION : 4.0]////////////////////////////
            //  if (!isset($complemento)) {
            //     $complemento =$Traslado['Complemento.TRASLADOS.Pago.0.DoctoRelacionado'];
            //       $color="blue";
            //        }

      /////// si no se define  formato 1 ,2 ó 3 se establece el formato que no esta bien emitido
            // if(!isset($complemento)){
            //      $complemento=['Complemento.0.TRASLADOS.Pago'];
            //      $color="yellow";
            // }
...
////// si $complemento no tiene datos se sale del ciclo
            if(!isset($complemento)){
                echo "No se encontraron datos para vincular<br>";
                continue;
            }//rompe el ciclo
       ...
       /////// se imprime los datos cfdi relacionados
             ...
             foreach($complemento as $c): echo "UUIDrelacionado".strtoupper($c['UUID'])."<br><br>";
$mayus=strtoupper($c['UUID']);
            ...
            endforeach;
             ...
             }elseif($color =="bluee" && count($complemento)>1){
                ...
                $uuid2=strtoupper($Traslado['Complemento.0.TRASLADOS.Pago.0.DoctoRelacionado.0.IdDocumento']);
                echo "simple&nbsp; UUIDrelacionado".strtoupper($Traslado['Complemento.0.TRASLADOS.Pago.0.DoctoRelacionado.0.IdDocumento'])."<br><br>";
            ...
            echo $id2= strtoupper($Traslado['Complemento.0.default:TRASLADOS.default:Pago.default:DoctoRelacionado.IdDocumento'])."<br><br>";
