...
/////////////////////////////////////////////////////////////////
    ...
    {
        $dateValue = strtotime($this->filesrelacionados->fecha);//obtener la fecha
        ...
        return view('livewire.relacionados', ['datos1' =>  $this->filesrelacionados, 'mesPago'=>$espa->fecha_es($mesfPago) ]);
    }
