                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-inline mr-auto">
                            <button type="button" class="btn btn-success BtnVinculadas"
                                onclick="ExportHoraClientExcel('{{ $empresa }}{{ $i }}', '{{ $empresa }}_Facturacion_{{ $fechainic }}_{{ $fechafin }}')">Excel</button>
                            &nbsp;&nbsp;

                            <button type="button" class="btn btn-danger BtnVinculadas"
                                onclick="ExportHoraClientPDF('{{ $empresa }}{{ $i }}', '{{ $empresa }}_Facturacion_{{ $fechainic }}_{{ $fechafin }}')">Pdf</button>
                            &nbsp;&nbsp;
                        </div>
