<div>
                ...
                <section class="invoice-list-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <div class="invoice-create-btn mb-1">
                                <button data-toggle="modal" data-target="#detalles" data-backdrop="static"
                                    data-keyboard="false" class="btn btn-secondary button2 DesatallesProv"
                                    id="BtnDetMoreProvUp" wire:click="EmitRFCArray()" disabled>Detalles Varios
                                    Proveedores</button>
                            </div>
                        </div>
                    </div>
                                    ...
                                    @if (!$NoCFDI == 0)
                                        <tr>
                                            ...
                                            <td class="text-center align-middle VincVarProv">
                                                <div id="checkbox-group" class="checkbox-group">
                                                    <input style="transform: scale(1.5);"
                                                        ...
                                                        wire:model.defer="moreprov" value="{{ $i['emisorRfc'] }}" />
                                                </div>
                                            </td>
                                            <td class="text-center align-middle">
                                                <span style="color:#3498DB"
                                                    class="invoice-amount">{{ $i['emisorRfc'] }}</span>
                                            </td>
                                            <td class="text-center align-middle">
                                                <span
                                            ...
                                            @if (!DB::collection('lista_negra')->select('RFC')->where(['RFC' => $i['emisorRfc']])->exists())
                                                <td class="td1 text-center align-middle"><img
                                                        src="{{ asset('img/ima.png') }}" alt=""></td>
                                            @else
                                                <td class="td1 text-center align-middle"><img
                                                        src="{{ asset('img/ima2.png') }}" alt=""></td>
                                            @endif
                                            ...
                                            <td class="text-center align-middle">
                                                ...
                                                <a class="icons fas fa-eye" data-backdrop="static" data-keyboard="false"
                                                    data-toggle="modal"
                        ...
                        @if ($rfcEmpresa)
                            <div>
                                <nav>
                                    <ul class="pagination">
                                        {{-- Boton de avanzar --}}
                                        <li id="minusreg" class="page-item" aria-disabled="true"
                                            aria-label="« Previous">
                                            <button class="page-link" type="button" rel="next" aria-label="Next »"
                                                wire:click="minusreg()">‹</button>
                                        </li>
                                        ...
                                        @if ($totalpagi > 10)
                                            ...
                                            @for ($i = 1; $i <= 2; $i++)
                                                ...
                                                <li class="page-item inicpagi btnselect{{ $i }}">
                                                    <button type="button" class="page-link"
                                                        wire:click="navpagi('{{ ($i - 1) * 10 }}', '{{ $i }}')">{{ $i }}</button>
                                                </li>
                                            @endfor

                                            {{-- Tres puntos de separador --}}
                                            <li class="page-item disabled inicpagi" aria-disabled="true"><span
                                            ...
                                            {{-- Tres puntos de separador --}}
                                            <li class="page-item disabled finpagi" aria-disabled="true"><span
                                                    class="page-link">...</span></li>
    ...
    {{-- Creacion del modal --}}
    <div wire:ignore.self class="modal fade" id="detalles" tabindex="-1" role="dialog"
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLabel"><span style="text-decoration: none;"
                            class="icons fas fa-folder-open">Cuentas por pagar</span></h6>
                    <h6 class="modal-title" id="exampleModalLabel"><span> Total seleccionado:
                            ${{ number_format(floatval($sumtotalfactu), 2) }}</span></h6>
                ...
                <div class="modal-body">
                    ...
                    <select wire:loading.attr="disabled" id="selectmovimul" class="select form-control"
                        wire:model="moviselect">
                    ...
                    @if ($showselect == 1)
                        ...
                        {{-- Select que contiene la lista de los cheques --}}
                        <select wire:loading.attr="disabled" id="selectprov" class="select form-control"
                            wire:model="proveselect" wire:change="sendrfc()">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            ...
                            @if ($btnvinactiv == 1)
                                <div class="invoice-create-btn mb-1">
                                    <button id="Btnvincufact" class="btn btn-primary" wire:click="VincuCFDIMovi()"
                                        onclick="guardarfactu('{{ $moviselect }}', '{{ $rfcEmpresa }}')">Vincular
                                        a Movimiento</button>
                                </div>
                            @else
                                <div class="invoice-create-btn mb-1">
                                    <button class="btn btn-primary" wire:click="VincuCFDIMovi()" disabled>Vincular a
                                        Movimiento</button>
                                </div>
                            @endif
                        </div>
                            ...
                            @if ($btnvinanewctiv == 1)
                                <div class="invoice-create-btn mb-1">
                                    <button class="btn btn-secondary" id="Btnmostrarnewcheq" data-backdrop="static"
                                        ...
                                        data-target="#newchequevincmul">Vincular a nuevo Movimiento</button>
                                </div>
                            @else
                                <div class="invoice-create-btn mb-1">
                                    <button class="btn btn-secondary" id="Btnmostrarnewcheq" disabled>Vincular a nuevo
                                        Movimiento</button>
                                </div>
                            @endif
                        </div>
                    ...
                    {{-- Filtro de busqueda --}}
                    <div class="form-inline mr-auto">
                        <input wire:model.debounce.300ms="searchcfdi" class="form-control" type="text"
                            placeholder="Filtro" aria-label="Search">
                    </div>
                                        ...
                                        <div class="form-check">
                                            ...
                                            @if ($efecto != 'Pago')
                                                <input wire:loading.attr="disabled"
                                                    id="Chkmul{{ $FolioCFDI->folioFiscal }}"
                                                    class="form-check-input ChkMul" type="checkbox"
                                                    wire:click="SumFactu()" wire:model="movivinc"
                                                    value="{{ $FolioCFDI->folioFiscal }}">
                                            @endif
                                            <label for="Chkmul{{ $FolioCFDI->folioFiscal }}"
                                                class="form-check-label">{{ $FolioCFDI->folioFiscal }}</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-body-cell">
                                        @if (!$XmlReci->isEmpty())
                                            @if (isset($Concept[0]['Descripcion']))
                                                {{ ++$ConceptCount }}.-
                                                {{ Str::limit($Concept[0]['Descripcion'], 20) }}
                                                <br>
                                            @endif
                                        @else
                                            {{ $Concept }}
    ...
    {{-- Modal de detalles de cuentas por pagar --}}
    {{-- Creacion del modal --}}
    <div wire:ignore.self class="modal fade" id="newchequevincmul" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                                ...
                                <form wire:submit.prevent="AgregarChequeCFDI">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            {{-- -tooltip- --}}
                                            <i id="info" class="fa fa-info-circle" aria-hidden="true"></i>
                                            <span id="factura" class="tooltiptext">En caso de no tener un número de
                                                factura,
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            {{-- -tooltip- --}}
                                            <i id="info" class="fa fa-info-circle" aria-hidden="true"></i>
                                            <span id="pagado" class="tooltiptext">La cantidad que se pagó con pesos
                                                y centavos.</span>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <span id="beneficiario" class="tooltiptext"> Razón social a quien
                                                realizó el pago.</span>

                                            <label for="inputCity">Beneficiario</label>
                                            <input class="form-control" wire:model="Nuevo_beneficiario" type="text"
                                                name="beneficiario" placeholder="A quien realizó el pago" required>
                                        </div>
                                        <div class="col">
                                            {{-- -tooltip- --}}
                                            <i id="info" class="fa fa-info-circle" aria-hidden="true"></i>
                                    ...
                                    <button type="submit" onclick="DataNewMov()" wire:loading.attr="disabled"
                    ...
                    <div class="step3" style="display:none;">
                        ...
                        <button type="button" wire:click="GotoChyT()" class="btn btn-secondary close-btn"
