...
<form class="form-inline" method="POST" id="emitidos-form">
    ...
    <div class="form-group">
        ...
        <select class="form-control m-2" id="anio-e1" name="anio_i">
    ...
    <div class="form-group">
        ...
        <select class="form-control m-2" id="dia-e2" name="dia_f">
            <?php foreach ($dias as $value) {
            echo '<option value="' . $value . '">' . $value . '</option>';
            } ?>
        </select>
    ...
    <div class="form-group">
        ...
        <select class="form-control m-2" id="anio-e2" name="anio_f">
            <?php foreach (array_reverse($anios) as $value) {
            echo '<option value="' . $value . '">' . $value . '</option>';
            } ?>
        </select>
    ...
    <div class="text-right">
        ...
        <a href="#bottomE" class="btn btn-primary ml-2">Ir a descargar</a>
    </div>
</form>
