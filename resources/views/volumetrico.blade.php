            ...
            <div class="row">
                <div class="col-3">
                    ...
                    <br><br><input type="submit" value="Enviar"
                        style="width: 90px; height: 35px;color:white; BORDER : #0055FF 1px solid; FONT-SIZE:13pt; background-color: #0055ff;">
                    ...
                    <br><br><input type="submit" value="Enviar"
                        style="color:white; BORDER : #0055FF 1px solid; FONT-SIZE:13pt; background-color: #0055ff;">
                </div>
            </div>
